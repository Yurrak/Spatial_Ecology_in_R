...
The municipality of Chongqing in southwestern China experienced an unprecedented compound heatwave and drought event during the summer of 2022. The event was characterised by record-breaking temperatures exceeding 45°C in some districts and a prolonged precipitation deficit relative to the historical average. In August 2022, the mean temperature reached 35°C, the highest recorded in the past 30 years. These extreme climatic conditions also triggered widespread wildfires across the region between mid- and late August 2022.

  ![Study Area](img/study_area.png)

The study area consists of a Sentinel-2 tile covering the southern part of Chongqing municipality, encompassing mountainous terrain, river valleys, and urban areas. This tile captures diverse land cover types and topographic conditions, providing a representative basis for assessing vegetation responses to the 2022 extreme climate event.

### Objectives

This project uses Sentinel-2 multispectral imagery and the R programming environment to investigate vegetation dynamics in the study area in response to the 2022 extreme heat and drought event. Two complementary analyses are conducted:

**Section 01** examines intra-annual vegetation dynamics by comparing pre-drought conditions (July 2022) with peak drought conditions (August 2022, prior to the wildfire outbreak). The analysis includes individual spectral band assessment, true and false colour composite visualisation, DVI and NDVI calculations, land cover classification, and vegetation distribution analysis.

**Section 02** adopts an inter-annual perspective by comparing August NDVI across four years (2020, 2021, 2022, and 2024). This analysis evaluates whether vegetation conditions in 2022 represent a significant anomaly relative to non-drought reference years and assesses the spatial extent of vegetation recovery by 2024.
...
The individual spectral bands (B2, B3, B4, B8A) were combined into multi-layer SpatRaster objects for July and August 2022 using the c( ) function. 

The bands were ordered as Red (B4), Green (B3), Blue (B2), and Near-Infrared (B8A) to facilitate subsequent true-color RGB visualization.
...
> **💡**  
>  
> From July to August, some areas visibly shift from green to yellowish-brown, indicating vegetation senescence and degradation that can be observed directly from the imagery. Urban and bare land areas in the upper-left corner appear light white and remain relatively stable between the two periods.
...
> **💡**  
>  
> From July to August, the left plain/valley trough areas have largely faded to dark red or brownish-red, indicating a decline in NIR reflectance. The mountain area in the lower-right corner, however, retains bright red, demonstrating spatial heterogeneity. 
> 
> The region's typical "parallel ridge-valley" topography is clearly visible, with sparse vegetation in the valleys and dense vegetation on the ridges. Under drought stress, the valley troughs experience heat accumulation and strong water evaporation, leading to particularly severe vegetation degradation.
> 
...
Sparse,moderate vegetation (grasslands, shrubs): 0.2 to 0.5; <br>
...
![Classification_2022_0.3](img/Classification_202207_202208.png)
...
Since the procedure was identical, the code is not shown separately. Only the corresponding analysis and visualisation results are presented.

![Classification_2022_0.4](img/Classification_202207_202208_2.png)
...
> **💡**
> 
> Both metrics identify 2022 as an outlier. Vegetation coverage drops to 75.4% (vs. ~81–85% in other years), and mean NDVI falls to 0.399 (vs. 0.421–0.450). The 2021 peak (84.6%, 0.450) provides the strongest contrast, confirming the severity of the 2022 heat and drought. By 2024, both coverage and mean NDVI have largely recovered.
...
> **💡**
> 
> Pixels showing both degradation (2020→2022 NDVI decline) and subsequent recovery (2022→2024 NDVI increase) are mapped in green. Recovery is mainly concentrated in valley troughs and low-elevation plains, while the ridges and mountainous areas in the lower portion part remain predominantly white, indicating limited drought-induced degradation. This suggests that these areas maintained relatively stable vegetation conditions during the 2022 event and therefore showed little subsequent recovery signal, reflecting greater resilience to drought stress.
...
Intra-annual analysis reveals a pronounced decline in NDVI from July to August 2022, especially the healthy vegetation cover. Spatially, degradation concentrated in ridge-valley areas and along river corridors in the upper-left region, likely amplified by the urban heat island effect and heightened sensitivity to water availability changes. Valley troughs experienced the most severe decline due to heat accumulation and moisture deficit, while ridges and higher-elevation areas  with dense vegetation patches identified in July (NDVI > 0.6) remained relatively resilient.

Inter-annual comparison against reference years (2020, 2021, 2024) confirms 2022 as a clear outlier, with vegetation coverage and mean NDVI dropping substantially below other years. The inter-annual SD map further identifies valley troughs as the most variable and vulnerable zones. Post-drought recovery by 2024 was widespread but incomplete; areas that experienced both degradation and subsequent recovery were concentrated in valleys, whereas topographically favored ridges and the lower-right higher-elevation mountainous area showed relatively stable NDVI throughout the study period. 
